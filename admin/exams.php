...
<div class="center">
    <h1 style="text-align: center;">Testy trybu egzaminu</h1>
    <div class="block">
        <ul class="mdc-list mdc-list--two-line" id="exams_list"> 
    ...
    <script>
        ...
        $('#editExamButton').click(function() {
            if ($('#EditquestionExamId').val() != "null") {
                ...
                $('#editExamDialog').css('display', '');
                //
                $.post('php_db_admin/GetExamItem.php', {
                        token: 'testToken',
        ...
        $('#delExamButton').click(function() {
            $.post('php_db_admin/DeleteExam.php', {
                    token: 'testToken',
                    ExamId: $('#EditquestionExamId').val()
                },
                function(data, status, jqXHR) {
        ...
        $('#SaveExamButton').click(function() {
            if ($('#isNewExam').val() == "true") {
                ...
                $.post('php_db_admin/EditExam.php', {
                        token: 'testToken',
                        ExamId: $('#EditquestionExamId').val(),
                        ExamName: $('#Exam_text').val(),
                        ExamInfo: $('#ExamInfo_text').val()
        ...
        function questionClick(id) {
            ...
            if (id != null) {
                $.post('php_db_admin/GetExamQuestion.php', {
                        token: 'testToken',
                        questionId: id
                    },
                    function(data, status, jqXHR) {
        ...
        function questionDeleteClick(id) {
            $.post('php_db_admin/DeleteExamQuestion.php', {
                    token: 'testToken',
                    QuestionId: id
                },
                function(data, status, jqXHR) {
        ...
        $('#SaveQuestionButton').click(function() {
            ...
            //if with id - update
            if ($('#questionId').val() != "") {
                $.post('php_db_admin/UpdateExamQuestion.php', {
                        token: 'testToken',
                ...
                $.post('php_db_admin/AddExamQuestion.php', {
                        token: 'testToken',
                        ExamId: $('#EditquestionExamId').val(),
                        Question: $('#Question_text').val(),
                        Base64Img: base64.slice(base64.indexOf(',') + 1),
